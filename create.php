...
if(isset($_POST['batal'])){
    header("Location: read.php");
        ...
        $create = mysqli_query($conn, "INSERT INTO `mhs`(`nim`, `nama`, `jurusan`, `foto`)
        VALUE ('$nim','$nama', '$jurusan', '$foto')");
        if($create){
            header("Location: read.php");
        }else{
    ...
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <!-- <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="contoh : 17410100010.jpg">
            </div> -->
