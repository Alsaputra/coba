...
elseif (isset($_POST["simpan"])) {
  ...
  $update = mysqli_query($conn, "UPDATE mhs SET `nim`='$nim', `nama`='$nama', `jurusan`='$jurusan' WHERE id = $id");
if($update){
  header("Location: read.php");
}else {
  ...
  <div class="container">
    ...
    <input type="hidden" name="id" value="<?= $mhs['id']?>">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="contoh : Jhon Doe" name="nama" value="<?= $mhs['nama'] ?>">
      </div>

      <!-- Select Jurusan -->
      <?php $jurusan = $mhs['jurusan'] ?>
      <div class="form-group">
        <label>Jurusan</label>
      ...
      <!-- <div class="form-group">
        ...
        <input type="text" class="form-control" value="17410100010.jpg">
      </div> -->
